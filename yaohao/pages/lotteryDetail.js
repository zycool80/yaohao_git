...
var _slicedToArray = function() {
...
}(), _wepy = require("./../npm/wepy/lib/wepy.js"), _wepy2 = _interopRequireDefault(_wepy), _api = require("./../api/api.js"), _api2 = _interopRequireDefault(_api), _DrawImage = require("./../utils/DrawImage.js"), _DrawImage2 = _interopRequireDefault(_DrawImage), _addApplets = require("./../components/addApplets.js"), _addApplets2 = _interopRequireDefault(_addApplets), _popupWindow = require("./../components/popupWindow.js"), _popupWindow2 = _interopRequireDefault(_popupWindow), _BackHome = require("./../components/BackHome.js"), _BackHome2 = _interopRequireDefault(_BackHome), _require = require("./../utils/utilsKit/index.js"), share = _require.share, tip = _require.tip, common = _require.common, redis = _require.redis, cache = _require.cache, underscore = _require.underscore, _require2 = require("./../models/GlobalModel.js"), ReportError = _require2.ReportError, getUserInfo = _require2.getUserInfo, getGlobalConfig = _require2.getGlobalConfig, isAddMyPrograme = _require2.isAddMyPrograme, _require3 = require("./../models/GStack.js"), _pageStack = _require3._pageStack, _lotNavbarStack = _require3._lotNavbarStack, Lottery = function(e) {
    function t() {
        var e, a, n, i;
    ...
    return _inherits(t, e), _createClass(t, [ {
        ...
        value: function() {
            var e = this;
            return new Promise(function(t) {
                Promise.all([ _api2.default.getProjectPrice(e.project_id, e.id), _api2.default.getSwiperImage(e.project_id), _api2.default.getDetails(e.project_id, e.id, e.is_not_lottery), _api2.default.getShareInfo({
                    page_name: "/pages/lotteryDetail",
                    lottery_id: e.id,
                    project_id: e.project_id
                }) ]).then(function() {
                    var a = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : res, n = _slicedToArray(a, 4), i = n[0], r = n[1], o = n[2], s = n[3];
        ...
        value: function() {
            ...
            return new Promise(function(t) {
                Promise.all([ _api2.default.houseTypePhotos(e.project_id, e.id, 0, e.id ? 1 : ""), _api2.default.getLotsalesMan(e.project_id), _api2.default.getLotCategories(e.id) ]).then(function() {
                    var a = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : res, n = _slicedToArray(a, 3), i = n[0], r = n[1], o = n[2];
        ...
        value: function() {
            ...
            return new Promise(function(t) {
                Promise.all([ _api2.default.historyLottery(e.project_id, e.id), _api2.default.getProjectCommentList(e.project_id), _api2.default.projectArticles(e.project_id), _api2.default.guessYouLike(e.project_id, 1), _api2.default.getLotMaterial(e.id, e.project_id) ]).then(function() {
                    var a = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : res, n = _slicedToArray(a, 5), i = n[0], r = n[1], o = n[2], s = n[3], c = n[4];
