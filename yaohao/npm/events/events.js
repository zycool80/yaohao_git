...
function _addListener(e, t, n, r) {
    ...
    if (o = e._events, void 0 === o ? (o = e._events = Object.create(null), e._eventsCount = 0) : (void 0 !== o.newListener && (e.emit("newListener", t, n.listener ? n.listener : n), 
    o = e._events), s = o[t]), void 0 === s) s = o[t] = n, ++e._eventsCount; else if ("function" == typeof s ? s = o[t] = r ? [ n, s ] : [ s, n ] : r ? s.unshift(n) : s.push(n), 
    (i = $getMaxListeners(e)) > 0 && s.length > i && !s.warned) {
        s.warned = !0;
...
function onceWrapper() {
    ...
    ReflectApply(this.listener, this.target, e));
}
...
var R = "object" == typeof Reflect ? Reflect : null, ReflectApply = R && "function" == typeof R.apply ? R.apply : function(e, t, n) {
...
Object.defineProperty(EventEmitter, "defaultMaxListeners", {
    ...
    if ("function" == typeof u) ReflectApply(u, this, t); else for (var f = u.length, v = arrayClone(u, f), n = 0; n < f; ++n) ReflectApply(v[n], this, t);
    return !0;
