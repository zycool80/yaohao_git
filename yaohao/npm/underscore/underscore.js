!function() {
    ...
    h.each = h.forEach = function(n, r, t) {
        r = y(r, t);
        var e, u;
        if (A(n)) for (e = 0, u = n.length; e < u; e++) r(n[e], e, n); else {
            var i = h.keys(n);
    ...
    var w = function(n) {
        var r = function(r, t, e, u) {
            var i = !A(r) && h.keys(r), o = (i || r).length, a = n > 0 ? 0 : o - 1;
    ...
    h.reduce = h.foldl = h.inject = w(1), h.reduceRight = h.foldr = w(-1), h.find = h.detect = function(n, r, t) {
        var e = A(n) ? h.findIndex : h.findKey, u = e(n, r, t);
        if (void 0 !== u && -1 !== u) return n[u];
        ...
        return A(n) || (n = h.values(n)), ("number" != typeof t || e) && (t = 0), h.indexOf(n, r, t) >= 0;
        ...
        h.map(n, function(n) {
            var i = u;
            if (!i) {
                if (e && e.length && (n = j(n, e)), null == n) return;
                i = n[r];
            }
        ...
        if (null == r || "number" == typeof r && "object" != typeof n[0] && null != n) {
            n = A(n) ? n : h.values(n);
            for (var a = 0, c = n.length; a < c; a++) null != (e = n[a]) && e > i && (i = e);
    ...
    h.toArray = function(n) {
        return n ? h.isArray(n) ? o.call(n) : h.isString(n) ? n.match(k) : A(n) ? h.map(n, h.identity) : h.values(n) : [];
    }, h.size = function(n) {
    ...
    var S = function(n, r, t, e) {
        e = e || [];
        for (var u = e.length, i = 0, o = _(n); i < o; i++) {
            var a = n[i];
    ...
    var F = function(n, r, t) {
        return function(e, u, i) {
            var a = 0, c = _(e);
            if ("number" == typeof i) n > 0 ? a = i >= 0 ? i : Math.max(i + c, a) : c = i >= 0 ? Math.min(i + 1, c) : i + c + 1; else if (t && i && c) return i = t(e, u), 
            e[i] === u ? i : -1;
    ...
    h.indexOf = F(1, h.findIndex, h.sortedIndex), h.lastIndexOf = F(-1, h.findLastIndex), 
    ...
    h.bind = g(function(n, r, t) {
        ...
        var e = g(function(u) {
            return E(n, e, r, this, t.concat(u));
        });
        return e;
    }), h.partial = g(function(n, r) {
        var t = h.partial.placeholder, e = function() {
        ...
        var c = function() {
            ...
            a || !1 !== t.leading || (a = l);
            var f = r - (l - a);
            return u = this, i = arguments, f <= 0 || f > r ? (e && (clearTimeout(e), e = null), 
            a = l, o = n.apply(u, i), e || (u = i = null)) : e || !1 === t.trailing || (e = setTimeout(c, f)), 
            o;
        };
    ...
    var N = !{
        toString: null
    }.propertyIsEnumerable("toString"), I = [ "valueOf", "isPrototypeOf", "toString", "propertyIsEnumerable", "hasOwnProperty", "toLocaleString" ], T = function(n, r) {
        var t = I.length, u = n.constructor, i = h.isFunction(u) && u.prototype || e, o = "constructor";
    ...
    h.pick = g(function(n, r) {
        var t = {}, e = r[0];
        if (null == n) return t;
        h.isFunction(e) ? (r.length > 1 && (e = y(e, r[1])), r = h.allKeys(n)) : (e = R, 
        ...
        var t, e = r[0];
        return h.isFunction(e) ? (e = h.negate(e), r.length > 1 && (t = r[1])) : (r = h.map(S(r, !1, !1), String), 
        e = function(n, t) {
    ...
    q = function(n, r, t, e) {
        ...
        if (t.push(n), e.push(r), o) {
            ...
            for (;f--; ) if (!q(n[f], r[f], t, e)) return !1;
        } else {
            var s, p = h.keys(n);
            if (f = p.length, h.keys(r).length !== f) return !1;
            for (;f--; ) if (s = p[f], !h.has(r, s) || !q(n[s], r[s], t, e)) return !1;
        }
    ...
    "function" != typeof /./ && "object" != typeof Int8Array && "function" != typeof z && (h.isFunction = function(n) {
        ...
        if (!h.isArray(r)) return null != n && c.call(n, r);
        for (var t = r.length, e = 0; e < t; e++) {
            var u = r[e];
    ...
    h.template = function(n, r, t) {
        ...
        n.replace(e, function(r, t, e, o, a) {
            return i += n.slice(u, a).replace(U, V), u = a + r.length, t ? i += "'+\n((__t=(" + t + "))==null?'':_.escape(__t))+\n'" : e ? i += "'+\n((__t=(" + e + "))==null?'':__t)+\n'" : o && (i += "';\n" + o + "\n__p+='"), 
            r;
    ...
    h.mixin = function(n) {
        return h.each(h.functions(n), function(r) {
            ...
            h.prototype[r] = function() {
                var n = [ this._wrapped ];
                return i.apply(n, arguments), $(this, t.apply(h, n));
            };
        }), h;
