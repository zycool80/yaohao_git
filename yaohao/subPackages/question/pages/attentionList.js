                ...
                return _asyncToGenerator(regeneratorRuntime.mark(function t() {
                    ...
                    return regeneratorRuntime.wrap(function(t) {
                        for (;;) switch (t.prev = t.next) {
                          case 0:
                            return t.next = 2, _api2.default.myAttention(e.page, e.user_id);

                          case 2:
                            n = t.sent, e.attentionList = n.data.data, e.count = n.data.count, e.page >= n.data.last_page || !n.data.last_page ? e.more = !1 : e.page++, 
                            e.$apply();
                        ...
                        for (;;) switch (t.prev = t.next) {
                          case 0:
                            return wx.showLoading({
                                title: "加载中"
                            }), e.page = 1, e.more = !0, e.loading = !0, t.next = 6, e.methods.loadNext.call(e);
            ...
            var t = _asyncToGenerator(regeneratorRuntime.mark(function e(t) {
                return regeneratorRuntime.wrap(function(e) {
                    for (;;) switch (e.prev = e.next) {
                      case 0:
                        return this.user_id = t.user_id || "", this.is_me = t.is_me, this.user_name = t.user_name, 
...
Page(require("./../../../npm/wepy/lib/wepy.js").default.$createPage(Index, "subPackages/question/pages/attentionList"));