...
var _createClass = function() {
    ...
    function t() {
        ...
        n.config = {
            navigationBarTitleText: "摇号助手-话题",
        ...
        value: function() {
            ...
            var t = _asyncToGenerator(regeneratorRuntime.mark(function e() {
                return regeneratorRuntime.wrap(function(e) {
                    for (;;) switch (e.prev = e.next) {
                      case 0:
                        return this.page = 1, this.more = !0, this.items = [], e.next = 5, this.loadNext();
        ...
        value: function() {
            ...
            var t = _asyncToGenerator(regeneratorRuntime.mark(function e() {
                ...
                return regeneratorRuntime.wrap(function(e) {
                    for (;;) switch (e.prev = e.next) {
                      case 0:
                        return e.next = 2, _api2.default.discussionTopic(this.page);

                      case 2:
                        t = e.sent, this.page >= t.last_page || !t.last_page ? this.more = !1 : this.page++, 
                        t.data.forEach(function(e) {
                            delete e.views;
                        }), this.items = this.items.concat(t.data), this.$apply();
...
Page(require("./../../../npm/wepy/lib/wepy.js").default.$createPage(Index, "subPackages/question/pages/discussList"));