                ...
                return _asyncToGenerator(regeneratorRuntime.mark(function t() {
                    ...
                    return regeneratorRuntime.wrap(function(t) {
                        for (;;) switch (t.prev = t.next) {
                          ...
                          case 2:
                            n = t.sent, "关注成功" === n.data ? e.item.attention = 1 : e.item.attention = 2, e.$apply();
                ...
                return _asyncToGenerator(regeneratorRuntime.mark(function r() {
                    ...
                    return regeneratorRuntime.wrap(function(r) {
                        for (;;) switch (r.prev = r.next) {
                          ...
                          case 3:
                            o = r.sent, "点赞成功" === o.data ? (a.like_num++, a.is_like = 1) : (a.like_num--, a.is_like = 2), 
                            n.$apply();
                ...
                return _asyncToGenerator(regeneratorRuntime.mark(function r() {
                    ...
                    return regeneratorRuntime.wrap(function(r) {
                        for (;;) switch (r.prev = r.next) {
                          ...
                          case 3:
                            o = r.sent, "收藏成功" === o.data ? (a.attention_num++, a.attention = 1) : (a.attention_num--, 
                            a.attention = 2), n.$apply();
                        ...
                        for (;;) switch (t.prev = t.next) {
                          case 0:
                            return wx.showLoading({
                                title: "加载中"
                            }), e.loading = !0, t.next = 4, _api2.default.getMyQuestionAnswer(e.user_id, e.sales_man_id);

                          case 4:
                            return n = t.sent, e.loading = !1, e.item = n.data, e.topics = e.item.topics, e.topics && (r = e.topics.join(""), 
                            a = e.topics.length, e.scrollViewWidth = 2 * a * 12 + 10 * a + 12 * r.length), e.questions = [], 
                            e.page = 1, e.more = !0, t.next = 14, e.methods.loadNext.call(e);
...
Page(require("./../../../npm/wepy/lib/wepy.js").default.$createPage(Index, "subPackages/question/pages/myQuestion"));