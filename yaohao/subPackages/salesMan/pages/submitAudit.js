                    ...
                    for (;;) switch (e.prev = e.next) {
                      case 0:
                        return wx.showLoading({
                            title: "加载中...",
                            mask: !0
                        }), this.page = 1, this.more = !0, this.modluDatas = [], e.next = 6, this.loadNext();

                      case 6:
                        wx.stopPullDownRefresh(), wx.hideLoading(), this.$apply();
        ...
        value: function() {
            ...
            var t = _asyncToGenerator(regeneratorRuntime.mark(function e() {
                ...
                return regeneratorRuntime.wrap(function(e) {
                    for (;;) switch (e.prev = e.next) {
                      case 0:
                        return e.next = 2, _api2.default.sales.getSubmitAuditList(this.page);

                      case 2:
                        t = e.sent, this.page > t.data.last_page || !t.data.last_page ? this.more = !1 : this.page++, 
                        this.modluDatas = this.modluDatas.concat(t.data.data), this.$apply();
...
Page(require("./../../../npm/wepy/lib/wepy.js").default.$createPage(SubmitAudit, "subPackages/salesMan/pages/submitAudit"));