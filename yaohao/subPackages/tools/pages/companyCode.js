...
var _createClass = function() {
    ...
    return _inherits(t, e), _createClass(t, [ {
            ...
            var t = _asyncToGenerator(regeneratorRuntime.mark(function e(t) {
                ...
                return regeneratorRuntime.wrap(function(e) {
                    for (;;) switch (e.prev = e.next) {
                      ...
                      case 2:
                        n = e.sent, this.businessQrCode = n.businessQrCode, this.$apply();
        ...
        value: function() {
            return share.share("商务合作");
        }
    } ]), t;
}(_wepy2.default.page);

Page(require("./../../../npm/wepy/lib/wepy.js").default.$createPage(Index, "subPackages/tools/pages/companyCode"));