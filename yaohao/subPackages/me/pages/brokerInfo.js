    ...
    return _inherits(t, e), _createClass(t, [ {
            ...
            var t = _asyncToGenerator(regeneratorRuntime.mark(function e(t) {
                ...
                return regeneratorRuntime.wrap(function(e) {
                    for (;;) switch (e.prev = e.next) {
                      ...
                      case 6:
                        for (a = e.sent, this.projectList = a.data, r = !0, i = !1, s = void 0, e.prev = 11, 
                      ...
                      case 27:
                        return !this.project_id && a && a.data.length > 0 && (this.project_id = a.data[0].project_id), 
                        e.next = 30, this.methods.reload.call(this);
        ...
        value: function() {
            ...
            var t = _asyncToGenerator(regeneratorRuntime.mark(function e() {
                var t, n, a, r, i, s, o, c, l, u, h, p, d, f, g, v, m, _, w, y, x, b = this;
                return regeneratorRuntime.wrap(function(e) {
                    for (;;) switch (e.prev = e.next) {
                      case 0:
                        return x = function(e, t, n) {
                            for (var a = 0; a < t.length; a++) e.setFontSize(18 * s), e.setTextBaseline("top"), 
                            e.setFillStyle("#d2b899"), e.fillText(t[a], n - 20, 50 * s + 12 * a);
                        }, y = function(e, n) {
                            ReportError.send({
                                errMsg: e,
                            ...
                            title: "生成中..."
                        }), t = this, n = wx.getSystemInfoSync(), a = n.windowWidth, r = 690, i = 1334, 
                        s = a / r, this.canvasWidth = r * s * .9, this.canvasHeight = i * s * .7, e.next = 8, 
                      ...
                      case 12:
                        c = e.sent, l = _slicedToArray(c, 6), u = l[0], h = l[1], p = l[2], d = l[3], f = l[4], 
                        g = l[5], u && h && p && d && f && g && (v = {
                            3: p,
                            2: d,
                            1: f
                        }, m = wx.createCanvasContext("myCanvas"), m.drawImage(h, 0, 0, this.canvasWidth, this.canvasHeight), 
                        m.save(), m.arc(60 * s + 120 * s / 2, 50 * s + 120 * s / 2, 60 * s, 0, 2 * Math.PI, !1), 
                        m.clip(), m.drawImage(u, 60 * s, 50 * s, 120 * s, 120 * s), m.restore(), _ = 100 * s, 
                        m.setFontSize(34 * s), m.setFillStyle("#1a1a1a"), m.fillText(this.salesManInfo.name, 205 * s, _), 
                        m.drawImage(v[this.salesManInfo.grade], 205 * s, _ + 27 * s, 21 * s, 28 * s), _ += 50 * s, 
                        m.setFontSize(24 * s), m.setFillStyle("#666"), m.fillText("经纪人", 240 * s, _), x(m, "成都摇号助手", this.canvasWidth), 
                        _ += 110 * s, m.setFontSize(40 * s), m.setFillStyle("#b3752b"), m.setTextAlign("center"), 
                        m.fillText("我在这里", this.canvasWidth / 2, _), _ += 73 * s, m.setFontSize(40 * s), 
                        m.setFillStyle("#b3752b"), m.setTextAlign("center"), m.fillText("等着你们一起入驻", this.canvasWidth / 2, _), 
                        w = (this.canvasWidth - 300 * s) / 2, _ += 97 * s, m.drawImage(g, w, _, 300 * s, 300 * s), 
                        m.setFontSize(20 * s), m.setFillStyle("#c6955f"), m.setTextAlign("center"), m.fillText("扫码和我一起入驻成都摇号助手", this.canvasWidth / 2, this.canvasHeight - 150 * s), 
                        m.setFontSize(34 * s), m.setFillStyle("#b3752b"), m.fillText(this.salesManInfo.like_num, 90 * s, this.canvasHeight - 100 * s), 
                        m.setFontSize(20 * s), m.setFillStyle("#666"), m.fillText("点赞", 90 * s, this.canvasHeight - 60 * s), 
                        m.setFontSize(34 * s), m.setFillStyle("#b3752b"), m.fillText(this.salesManInfo.recommend_index, this.canvasWidth / 2 - 80 * s, this.canvasHeight - 100 * s), 
                        m.setFontSize(20 * s), m.setFillStyle("#666"), m.fillText("活跃度", this.canvasWidth / 2 - 80 * s, this.canvasHeight - 60 * s), 
                        m.setFontSize(34 * s), m.setFillStyle("#b3752b"), m.fillText(this.salesManInfo.consulting, this.canvasWidth / 2 + 80 * s, this.canvasHeight - 100 * s), 
                        m.setFontSize(20 * s), m.setFillStyle("#666"), m.fillText("咨询量", this.canvasWidth / 2 + 80 * s, this.canvasHeight - 60 * s), 
                        m.setFontSize(34 * s), m.setFillStyle("#b3752b"), m.fillText(this.salesManInfo.page_views, this.canvasWidth - 90 * s, this.canvasHeight - 100 * s), 
                        m.setFontSize(20 * s), m.setFillStyle("#666"), m.fillText("浏览量", this.canvasWidth - 90 * s, this.canvasHeight - 60 * s), 
        ...
        value: function(e) {
            var t = "/subPackages/me/pages/broker?inviter_id=" + this.salesMan_id;
            return _index.share.share(this.shareTitle, t);
        }
    }, {
        key: "reload",
        value: function() {
                ...
                return regeneratorRuntime.wrap(function(e) {
                    for (;;) switch (e.prev = e.next) {
                      case 0:
                        ...
                        return e.next = 4, _api2.default.salesManDetail2(this.project_id);
...
Page(require("./../../../npm/wepy/lib/wepy.js").default.$createPage(Index, "subPackages/me/pages/brokerInfo"));