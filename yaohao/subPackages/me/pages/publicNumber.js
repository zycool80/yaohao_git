...
var _createClass = function() {
    ...
    function t() {
        ...
        r.config = {
            navigationBarTitleText: "摇号助手-官方公众号"
        }, r.data = {
            groupInfo: {
                wechat_code: "https://imgcdn.huanjutang.com/assert/img/15541858870317197.jpg"
            }
        }, r.computed = {
            showHome: function() {
                ...
                return _asyncToGenerator(regeneratorRuntime.mark(function t() {
                    ...
                    return regeneratorRuntime.wrap(function(t) {
                        for (;;) switch (t.prev = t.next) {
                          case 0:
                            return t.next = 2, _index.tip.confirm("确认保存图片吗？", "提示");

                          case 2:
                            n = t.sent, n && wx.downloadFile({
                                url: e.groupInfo.wechat_code,
                                success: function(e) {
...
Page(require("./../../../npm/wepy/lib/wepy.js").default.$createPage(Index, "subPackages/me/pages/publicNumber"));