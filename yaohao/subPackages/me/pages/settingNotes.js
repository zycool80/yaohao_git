                ...
                return _asyncToGenerator(regeneratorRuntime.mark(function t() {
                    ...
                    return regeneratorRuntime.wrap(function(t) {
                        for (;;) switch (t.prev = t.next) {
                          case 0:
                            return t.next = 2, _api2.default.setChatComment({
                                object_id: e.object_id,
                                name: e.name,
                                phone: e.phone,
                                wechat_code: e.number,
                                comment: e.text
                            });

                          case 2:
                            n = t.sent, _index.tip.toast(n.data, "", "");
            ...
            var t = _asyncToGenerator(regeneratorRuntime.mark(function e(t) {
                ...
                return regeneratorRuntime.wrap(function(e) {
                    for (;;) switch (e.prev = e.next) {
                      case 0:
                        return this.object_id = t.object_id, e.next = 3, _api2.default.getChatComment(this.object_id);

                      case 3:
                        n = e.sent, this.result = n.data, this.name = this.result.name, this.phone = this.result.phone, 
                        this.number = this.result.wechat_code, this.text = this.result.comment, this.$apply();
...
Page(require("./../../../npm/wepy/lib/wepy.js").default.$createPage(Index, "subPackages/me/pages/settingNotes"));