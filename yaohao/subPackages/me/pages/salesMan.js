...
var _createClass = function() {
    ...
    function t() {
        ...
        a.config = {
                ...
                return _asyncToGenerator(regeneratorRuntime.mark(function t() {
                    ...
                    return regeneratorRuntime.wrap(function(t) {
                        for (;;) switch (t.prev = t.next) {
                          ...
                          case 2:
                            n = t.sent, e.type = n.data, e.gui_url = n.url, e.invite_url = n.invite_url, e.isSalesMan = n.isSalesMan, 
                            e.$apply();
            ...
            delImg: function(e) {
                1 == e ? this.inputData.wechat_qrcode = "" : this.inputData.card = "", this.$apply();
            },
            changType: function() {
                ...
                return _asyncToGenerator(regeneratorRuntime.mark(function t() {
                    return regeneratorRuntime.wrap(function(t) {
                        for (;;) switch (t.prev = t.next) {
                          ...
                          case 6:
                            if (e.inputData.project_name && !e.inputData.project_name.match(/^\s*$/)) {
                                t.next = 8;
                                break;
                            }
                            return t.abrupt("return", _index.tip.toast("请填写楼盘名称", "", "none"));
                        ...
                        for (;;) switch (t.prev = t.next) {
                          ...
                          case 10:
                            a = t.sent, 0 == a.code && wx.redirectTo({
                                url: "/subPackages/news/pages/salesManTip?type=1"
            ...
            var t = _asyncToGenerator(regeneratorRuntime.mark(function e(t) {
                ...
                return regeneratorRuntime.wrap(function(e) {
                    for (;;) switch (e.prev = e.next) {
                      case 0:
                        return e.next = 2, this.methods.chang_type.call(this);

                      case 2:
                        this.project_id = t.id, this.sales_man_id = _index.cache.get("sales_man_id"), 1 == t.type && (this.showModel = !0, 
                        this.showTextarea = !1), this.$apply(), t.inviter_id && _api2.default.getInviterName(t.inviter_id).then(function(e) {
...
Page(require("./../../../npm/wepy/lib/wepy.js").default.$createPage(Index, "subPackages/me/pages/salesMan"));