...
var _createClass = function() {
    ...
    function t() {
        ...
        r.config = {
            navigationBarTitleText: "管理绑定的信息"
        }, r.data = {
            userInfo: {},
            typeIndex: 0,
            maxLength: 200,
                        ...
                        for (;;) switch (t.prev = t.next) {
                          ...
                          case 5:
                            return wx.showLoading({
                                title: "加载中..."
                            }), t.next = 8, _api2.default.feedback(n);

                          case 8:
                            return r = t.sent, wx.hideLoading(), t.next = 12, _wepy2.default.showModal({
...
Page(require("./../../../npm/wepy/lib/wepy.js").default.$createPage(Index, "subPackages/me/pages/manageUsers"));