    ...
    return _inherits(t, e), _createClass(t, [ {
        ...
        value: function() {
            ...
            globalModel.getGlobalConfig().then(function(t) {
                e.img_url = t.me_guide_img, e.code = t.wechatQrCode;
            }), this.$apply();
        }
    }, {
        key: "onShareAppMessage",
        value: function(e) {
            return _index.share.share("一张图让你了解他的一切");
        }
    } ]), t;
}(_wepy2.default.page);

Page(require("./../../../npm/wepy/lib/wepy.js").default.$createPage(Index, "subPackages/me/pages/strangerDirect"));