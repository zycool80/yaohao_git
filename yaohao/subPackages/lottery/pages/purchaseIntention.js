                ...
                return _asyncToGenerator(regeneratorRuntime.mark(function t() {
                    ...
                    return regeneratorRuntime.wrap(function(t) {
                        for (;;) switch (t.prev = t.next) {
                          case 0:
                            return t.next = 2, _api2.default.delUserData();

                          case 2:
                            return n = t.sent, 0 == n.code && _index.tip.toast("删除成功", "", "none"), t.next = 6, 
                            e.reload();
            ...
            var t = _asyncToGenerator(regeneratorRuntime.mark(function e() {
                ...
                return regeneratorRuntime.wrap(function(e) {
                    for (;;) switch (e.prev = e.next) {
                      case 0:
                        return this.loading = !1, e.next = 3, _api2.default.getUserData(this.user_id);

                      case 3:
                        t = e.sent;
                        for (n in t.data.intention) r = t.data.intention[n], "" == r && this.count++, this.projects.push({
                            title: n,
                            list: r
                        });
                        this.loading = !0, this.$apply(), wx.hideLoading();
        ...
        value: function() {
            ...
            var t = _asyncToGenerator(regeneratorRuntime.mark(function e() {
                return regeneratorRuntime.wrap(function(e) {
                    for (;;) switch (e.prev = e.next) {
                      case 0:
                        return this.user_id = _index.cache.get("userinfo").id, e.next = 3, this.reload();
...
Page(require("./../../../npm/wepy/lib/wepy.js").default.$createPage(Index, "subPackages/lottery/pages/purchaseIntention"));