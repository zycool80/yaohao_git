...
var _createClass = function() {
    ...
    return _inherits(t, e), _createClass(t, [ {
        ...
        value: function(e) {
            var t = this;
            this.user_id = e.id, _api2.default.getUserData(this.user_id).then(function(e) {
                t.user_info = e.data.user_info;
                for (var n in e.data.intention) t.intention.push({
                    title: n,
                    list: e.data.intention[n]
                });
                t.$apply();
            });
        }
...
Page(require("./../../../npm/wepy/lib/wepy.js").default.$createPage(Index, "subPackages/lottery/pages/ordinaryUser"));