...
var _slicedToArray = function() {
    ...
    return _inherits(t, e), _createClass(t, [ {
        ...
        value: function() {
            return _index.share.share("这里有所有的不限购楼盘，再也不用到处去找啦");
        }
    }, {
        key: "reload",
        value: function() {
            ...
            var t = _asyncToGenerator(regeneratorRuntime.mark(function e() {
                ...
                return regeneratorRuntime.wrap(function(e) {
                    for (;;) switch (e.prev = e.next) {
                      case 0:
                        return this.page = 1, this.more = !0, this.projects = [], e.next = 5, _api2.default.getBannerList(6);
...
Page(require("./../../../npm/wepy/lib/wepy.js").default.$createPage(Index, "subPackages/project/pages/noLimitPay"));