                    ...
                    return regeneratorRuntime.wrap(function(r) {
                        for (;;) switch (r.prev = r.next) {
                          case 0:
                            ...
                            return r.next = 3, _api2.default.getPhoneNum(t.project_id, 2);

                          case 3:
                            n = r.sent, 0 === n.code && wx.showModal({
                                title: "提示",
            ...
            reload: function() {
                ...
                return _asyncToGenerator(regeneratorRuntime.mark(function t() {
                    return regeneratorRuntime.wrap(function(t) {
                        for (;;) switch (t.prev = t.next) {
                          case 0:
                            return e.more = !0, e.page = 1, e.items = [], t.next = 5, e.methods.loadNext.call(e);

                          case 5:
                            return t.next = 7, e.methods.getSaleMan.call(e);
            ...
            loadNext: function() {
                ...
                return _asyncToGenerator(regeneratorRuntime.mark(function t() {
                    ...
                    return regeneratorRuntime.wrap(function(t) {
                        for (;;) switch (t.prev = t.next) {
                          case 0:
                            return e.loading = !1, r = 1 == e.tab ? e.lottery_id : "", t.next = 4, _api2.default.houseTypePhotos(e.project_id, r, e.typeTo, e.tab);

                          case 4:
                            n = t.sent, e.loading = !0, e.items = n.data, e.phone = n.phone, e.$apply(), wx.hideLoading();
            ...
            var t = _asyncToGenerator(regeneratorRuntime.mark(function e(t) {
                ...
                return regeneratorRuntime.wrap(function(e) {
                    for (;;) switch (e.prev = e.next) {
                      case 0:
                        return this.project_id = t.project_id, this.lottery_id = t.lottery_id || "", this.project_name = decodeURIComponent(t.project_name), 
                        r = [ {
                            text: "全部",
                            type: 0
                        } ], e.next = 6, _api2.default.getBtnStatus(this.lottery_id, this.project_id);

                      case 6:
                        return n = e.sent, this.attetionList = n.data, e.next = 10, _api2.default.houseType(this.project_id, "", 1);

                      case 10:
                        return a = e.sent, this.typeListNow = r.concat(a.data), this.scrollWidthNow = 95 * parseInt(this.typeListNow.length), 
                        e.next = 15, _api2.default.houseType(this.project_id, "", "");

                      case 15:
                        return o = e.sent, this.typeList = r.concat(o.data), this.scrollWidth = 95 * parseInt(this.typeList.length), 
                        this.tab = "", this.type = 0, this.typeTo = 0, e.next = 23, this.methods.reload.call(this);
...
Page(require("./../../../npm/wepy/lib/wepy.js").default.$createPage(Index, "subPackages/project/pages/housePlan"));