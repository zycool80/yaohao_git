...
var _createClass = function() {
    ...
    function t() {
        ...
        r.config = {
            ...
            prePic: function() {
                wx.previewImage({
                    urls: [ this.getPicList[10] ]
                });
            },
            preImages: function(e) {
                wx.previewImage({
                    current: e,
                    urls: this.getPicList
                });
            },
            toRules: function(e) {
                var t = this;
                    ...
                    return regeneratorRuntime.wrap(function(t) {
                        for (;;) switch (t.prev = t.next) {
                          case 0:
                            ...
                            for (i in r) a = r[i], s = new RegExp("." + a, "i"), s.test(e) && (o = a);
                            wx.downloadFile({
                                url: e,
                                success: function(e) {
                        ...
                        for (;;) switch (t.prev = t.next) {
                          case 0:
                            return wx.showLoading({
                                title: "加载中..."
                            }), t.next = 3, _api2.default.timeAxisInfo(e.lottery_id, 2);

                          case 3:
                            return n = t.sent, t.next = 6, _api2.default.getGuidePic();

                          case 6:
                            r = t.sent, e.getPicList = r.data, e.contents = n.data, e.$apply(), wx.hideLoading();
    ...
    return _inherits(t, e), _createClass(t, [ {
        ...
        value: function(e) {
            return _index.share.share(this.name + "楼盘的购房网络登记指南");
        }
    } ]), t;
}(_wepy2.default.page);

Page(require("./../../../npm/wepy/lib/wepy.js").default.$createPage(Index, "subPackages/project/pages/registry"));