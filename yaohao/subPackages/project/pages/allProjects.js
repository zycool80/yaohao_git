...
var _slicedToArray = function() {
...
}(), _wepy = require("./../../../npm/wepy/lib/wepy.js"), _wepy2 = _interopRequireDefault(_wepy), _api = require("./../../../api/api.js"), _api2 = _interopRequireDefault(_api), _index = require("./../../../utils/utilsKit/index.js"), _ProjectItem = require("./../../../components/ProjectItem/ProjectItem.js"), _ProjectItem2 = _interopRequireDefault(_ProjectItem), _BackHome = require("./../../../components/BackHome.js"), _BackHome2 = _interopRequireDefault(_BackHome), globalModel = require("./../../../models/GlobalModel.js"), _ = _index.underscore, AllProjects = function(e) {
    function t() {
        var e, a, r, n;
        ...
        r.config = {
            ...
            ProjectItems: _ProjectItem2.default
        }, r.methods = {
            ...
            bannerAdClickHandle: function(e, t) {
                wx.$Analysis.sendEvent("不限购-banner广告", {
                    banner_id: e.id,
                    banner_index: t
                });
            }
    ...
    return _inherits(t, e), _createClass(t, [ {
        ...
        value: function() {
            return _index.share.share("这里有所有的楼盘，再也不用到处去找啦");
        }
    }, {
        key: "reload",
        value: function() {
            ...
            var t = _asyncToGenerator(regeneratorRuntime.mark(function e() {
                ...
                return regeneratorRuntime.wrap(function(e) {
                    for (;;) switch (e.prev = e.next) {
                      case 0:
                        return this.page = 1, this.more = !0, this.projects = [], e.next = 5, _api2.default.getBannerList(11);

                      case 5:
                        return t = e.sent, this.banners = t.data, e.next = 9, this.loadNext();
                    ...
                    for (;;) switch (e.prev = e.next) {
                      case 0:
                        return t = _.extend({}, this.params, {
                            ...
                            keyword: "",
                            type: 0
                        }), e.next = 3, _api2.default.getProjects(t);
...
Page(require("./../../../npm/wepy/lib/wepy.js").default.$createPage(AllProjects, "subPackages/project/pages/allProjects"));