...
var _createClass = function() {
    ...
    return _inherits(t, e), _createClass(t, [ {
        ...
        value: function() {
            ...
            var t = _asyncToGenerator(regeneratorRuntime.mark(function e() {
                ...
                return regeneratorRuntime.wrap(function(e) {
                    for (;;) switch (e.prev = e.next) {
                      case 0:
                        return e.next = 2, _api2.default.article.projectArticle(0, "", this.page, 1, "");

                      case 2:
                        t = e.sent, this.page >= t.data.last_page || !t.data.last_page ? this.more = !1 : this.page++, 
                        this.articles = this.articles.concat(t.data.data);
        ...
        value: function() {
            return _index.share.share("每天房小团，省下装修钱");
        }
    } ]), t;
}(_wepy2.default.page);

Page(require("./../../../npm/wepy/lib/wepy.js").default.$createPage(Index, "subPackages/news/pages/hotArticle"));