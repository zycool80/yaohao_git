            ...
            var t = _asyncToGenerator(regeneratorRuntime.mark(function e(t) {
                ...
                return regeneratorRuntime.wrap(function(e) {
                    for (;;) switch (e.prev = e.next) {
                      case 0:
                        return n = t.type ? parseInt(t.type) : 1, e.next = 3, globalModel.getGlobalConfig();

                      case 3:
                        r = e.sent, this.img = 1 === n ? r.customerService : r.broker, this.$apply();
...
Page(require("./../../../npm/wepy/lib/wepy.js").default.$createPage(Index, "subPackages/news/pages/salesManTip"));